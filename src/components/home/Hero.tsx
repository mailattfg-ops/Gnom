                ...
                <div className="max-w-3xl">
                    ...
                    <div className="flex flex-wrap gap-4 items-center">
                        <Link
                            ...
                            className="group relative px-6 py-3 sm:px-8 sm:py-4 lg:px-10 lg:py-5 bg-brand text-white rounded-xl font-black text-sm sm:text-base lg:text-xl overflow-hidden transition-all hover:scale-105 active:scale-95 italic uppercase tracking-tighter inline-flex items-center"
                        >
                            <span className="relative z-10 flex items-center gap-2">
                                Start a Project <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 group-hover:translate-x-2 transition-transform" />
                            </span>
                        ...
                        <Link
                            href="/services"
                            className="px-6 py-3 sm:px-8 sm:py-4 lg:px-10 lg:py-5 bg-white/5 backdrop-blur-md border-2 border-white/10 rounded-xl font-black text-sm sm:text-base lg:text-xl text-white transition-all hover:bg-white/10 hover:border-white/20 italic uppercase tracking-tighter inline-flex items-center"
                        >
                            View Our Services
                        </Link>
                    </div>
