...
import { Target, Eye, Award, Users, ChevronRight, Binary } from "lucide-react";
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-stretch">
                        ...
                        <div className="flex flex-col justify-between space-y-16 h-full">
                            ...
                            <GnomCard rotate="-rotate-1" padding="p-10">
                                ...
                                <button className="flex items-center gap-3 text-brand font-black uppercase tracking-widest text-xs group">
                                    Learn about our core values <ChevronRight className="w-4 h-4 group-hover:translate-x-2 transition-transform" />
                                </button>
                            </GnomCard>
                        </div>
